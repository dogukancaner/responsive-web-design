      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px-4 py-12">
          ...
          <p className="py-4 text-3xl text-slate-300 ">
            ...
            repudiandae veritatis ratione error stenetur, voluptates architecto
            possimus ad! Omnis minima ea quidem quisquam unde beate, minus illo
            et cum vel?
          </p>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <p className="text-gray-600 text-xl">
                ...
                quidem hic voluptatem ut similique maiores perferendis vel porro
                nihil! Molestias, magni eius. Saepe eius quasi in exercitationem
